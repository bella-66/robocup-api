...
robocupdb.getResultsByTeam = async (req, res) => {
  try {
    ...
    const [results] = await pool.query(
      ...
      vysledky.vysledok_1,vysledky.vysledok_2,osoba.meno,osoba.priezvisko,osoba.id_osoba,timeline.datum_a_cas,timeline.druh_operacie,sutaz.nazov FROM vysledky left join osoba on 
